...
const MC = [
 ...
 {q:"Miso Seabass prep:",o:["Miso/mirin/sake 48–72 hours, pan seared, broiled","Battered and fried with kung pao","Raw with mignonette","Grilled with peppercorn sauce only"],t:"food"},
 ...
 {q:"How does the 48 oz Porterhouse break down?",o:["USDA Choice: about a 22 oz NY strip + a 12 oz filet + a 10 oz bone, $170 — built for two to split","A 26 oz NY strip + a 14 oz filet + a 12 oz bone","An 18 oz NY strip + a 10 oz filet + a 14 oz bone","A 24 oz NY strip + an 8 oz filet + a 14 oz bone"],t:"steak"},
...
/* ===== distribution build-out, 8/6 — every answer from LOCKED facts only ===== */
 ...
 {"q": "Our draft cocktail situation is…", "o": ["Two lines total — the Smoked Draft Old Fashioned, and the Sweet & Salty (the Transfusion): grapefruit and Tito's on tap, salted rim, topped with Sprite", "Six rotating lines", "No taps at all", "Both lines are Old Fashioneds"], "t": "cocktail"},
...
const OPEN = [
 ...
 ["Describe the Miso Seabass and the miso prep.","Patagonian toothfish marinated in white miso, mirin, and sake for 48–72 hours, pan-seared and finished in the broiler. Coconut risotto and Brussels sprouts."],
...
["Starters","what rides out with each one",[
 "<b>Tongs:</b> calamari, wagyu tacos.",
 "<b>Two metal Japanese chopsticks (per person):</b> crispy ahi tuna bites, A5 nigiri.",
