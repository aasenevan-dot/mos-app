...
const SCHEDULE={
 ...
 sections:[
  ...
  ["Fronts",[
   ["Alexis","11/345","330","4 MGR","330","","","345"],
   ["Chad","OFF","330","330","4 MGR","","","345"],
   ["Hunter","345","OFF","330","330","OFF","OFF","OFF"],
   ["Diana","11/345","","330","330","3","345",""],
   ["MorganB","","","330","330","3","345",""],
   ["Calista","345","330","330","330","","345",""],
   ["Nathan","OFF","","330","330","OFF","345","345"],
   ["Fabian","","330","330","330","","345","345"],
   ["Alex","345","","330","330","3","OFF","345"]
  ],["15","41","39","31","2","2","2"]],
  ["Backs",[
   ["Lupe","","","","","","",""],
   ["Morgan W","11/345","","330","330","3","345","OFF"],
   ["Evan","OFF","","330","330","3","345","OFF"],
   ["Erin","345","330","330","330","","345",""],
   ["J Fox","11/345","330","330","330","","345","345"],
   ["D","","","330","330","3","","345"],
   ["Meagan","OFF","330","330","330","3","345","345"],
   ["Abby","OFF","RO","RO","RO","","345","RO"],
   ["Barbie","345","330","330","330","3","OFF","OFF"],
   ["Victoria","","","","","","",""]
  ]],
  ["Bar",[
   ["Krista","","RO","5","3","3","5",""],
   ["Christian","3","4","430","3","","5",""],
   ["Jennea","5","","3","5","","3",""]
  ]],
  ["Cktail",[
   ["Jenny","4","4","330","330","","4",""],
   ["Taylor","","3","330","330","330","","345"]
  ]],
  ["Host",[
   ["Kalie","","4","5","","5","4",""],
   ["Mackenzie","RO","RO","RO","","5","4",""],
   ["Leila","4","5","4","5","4","",""]
  ]],
  ["Expo",[
   ["CARTER","4","5","OFF","5 Busser","OFF","4",""],
   ["Jackson","RO","4","4","4","4","","4"],
   ["Rodrigo","RO","RO","4","RO","5","","4"]
  ]],
  ["Busser",[
   ["Dalton","OFF","","5","4","5","4",""],
   ["Conner","4","5","RO","5","4","4",""],
...
const SCHEDULE_HISTORY=[
{
 ...
 note:"Transcribed from Craig's posted sheet; right-side days and a few Bar/Host/Busser cells were hard to read \u2014 verify against the sheet.", src:"schedule photos 8/19-8/25"
},
{
